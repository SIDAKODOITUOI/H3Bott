...
module.exports.run = async ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  var callback = () => api.sendMessage({
    body: `梁ADMIN BOT梁
  👀 Họ và tên:Huỳnh Thụy Dương Trúc 
  ❎ Tuổi: 17
  👤 Giới tính:Nữ 
  🙄 Sinh ngày:27/04/2004
  💫 Chiều cao / cân nặng: 1m65/ kg 52
  💘 Mối quan hệ:Hẹn hò zới tân tân 
  😎 Quê quán:TPHCM 
  🤔 Nơi ở:TPHCM
  ♓ Cung: Kim ngưu 
  ...
  📱 Facebook: https://www.facebook.com/emyeuanhlamnhaa
...
💳MB: 0776791027
📲Zalo: 0798794096
----Trúc cute----`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")
